      ...
      <div className="project-content">
        ...
        <div className="project-section">
          ...
          <p>
            ...
            to. Spotify and Apple Music's algorithmic recommendation systems are
            great for finding more of the kind of music I already know I love.
            They're not so great for finding albums that are totally out of
            left-field for me but might just be my next obsession.
          </p>
        ...
        <div className="project-section">
          ...
          <p>
            For my app's proof-of-concept, I spent some time finding albums that
            spanned different decades and genres which I could use to test my
            app.
          </p>
          <p>
            ...
            endpoint of Spotify's Web API console to download a json with all of
            the album data.{" "}
          </p>
          .
        </div>
        <div className="project-section">
          ...
          <p>
            There were five components I created besides App.js which I used to
        ...
        <div className="project-section">
          ...
          <ul>
            <li>
              <b>queue</b> contains a list of albums which represent the queue.
              Clicking the "Add to Queue" button on an album card adds that
              album to the list. Clicking the minus button on an queue item
              removes that album from the list.
            </li>
          </ul>
          <div className="inline-section rounded-section">
            <div className="img-wrapper">
          ...
          <ul>
            ...
            <li>
              <b>sort</b> represents the current sorting method used to display
              the albums. Selecting different options in the "Sort by" dropdown
              box changes the state to "newest", "oldest", and "popular"
              respectively. If no option has been selected, the state is ""
            </li>
            <li>
        ...
        <div className="project-section">
          ...
          <p>
            ...
            still crucial. I considered the following usability principles in my
            project
          </p>
          ...
          <ul>
            <li>
              Album items are displayed as squares organized into a grid, while
              queue items are displayed as rectangles organized into a list in
              order to create visual distinction between the sections.
            </li>
            <li>
              Purple is used to accent elements on the site that can be
              interacted with, such as the buttons to add and remove items from
              the queue, the sliders, and the checkboxes when they are checked.
            </li>
          </ul>
        ...
        <div className="project-section">
          ...
          <p>
            ...
            the fact that I could actually envision me and my friends making use
            of an app or site like this provided extra motivation to build it as
            well as I could. Here were my main takeaways:
          </p>
          <ol>
            <li>
              <b>Make use of component libraries.</b> The MUI component library
              is great, both with regards to the documentation and the
              components themselves. I love custom styling my interface elements
              as much as anyone else, but using MUI in this project freed me up
              to dedicate my primary focus on the app architecture and program
              logic.
            </li>
            <li>
              <b>You don't need to do everything at once!</b> I spent a lot of
              time trying to figure out how to extract data from the API
              directly in the React app, and never ended up being able to figure
              it out. Sometimes the smartest move is to shelve certain features
