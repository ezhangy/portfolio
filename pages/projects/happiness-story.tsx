    ...
    <>
      ...
      <main>
        ...
        <div className="project-content">
          ...
          <div className="project-section">
            ...
            <p>
              ...
              work together with reporters to create interactive stories. We
              help build a story's front-end, scrape data and create graphics.
              The Data Desk's previous projects include a story about the{" "}
        ...
        <div className="project-section">
          ...
          <h2 className="big-section-title">
            A Visual Essay about Happy Places
          </h2>
          <p>
            ...
            on campus that made them happy. To accompany the interviews, a set
            of photos were taken of each happy place.
          </p>
          <p>
        ...
        <div className="project-section">
          ...
          <p>
            ...
            the components of the story. We had an interesting statistic about
            the percentage of happy undergrads, which we knew we wanted to lead
            the story.{" "}
          </p>
          ...
          <p>
            ...
            naturally. The tougher design choice stemmed from the fact that
            there were two photos of each location—one wide shot and one
            close-up—both of which we wanted to incorporate in the story. How
            could we make the switch between them interesting?
          </p>
          ...
          <p>
            Ultimately, we decided to make the wide shots grayscale, while
            keeping the close shots in color. When a reader has scrolled halfway
            through a given interview, the photo switches to the color image at
            the same time background color turns from black to a bright hue from
            the color image. We thought these color transitions would
            effectively convey the joy that these locations spark.
          </p>
        </div>
        <div className="project-section">
          ...
          <p>
            ...
            the scroll position by adding together $(this).scrollTop() (the
            number of pixels scrolled on the document) and $(window).height()
            (the height of current viewport). If the scroll position is greater
            than an HTML element's position (which you can calculate with
            $(#id).offset().top), this means that the element has scrolled past
          ...
          <p>
            ...
            faded, you should remove it from the HTML document so you're only
            ever dealing with two images at once.
          </p>
        ...
        <div className="project-section">
          ...
          <p>
            ...
            site, we had to ensure it also looked good on your phone. The
            biggest layout changes involved placing elements on top of each
            other than side-by-side. For example, we had to change the layout of
            the article title and chart. Similarly, we placed the story images
            at the top of the screen and the interview text below it, rather
            than side-by-side.{" "}
          </p>
          ...
          <p>
            ...
            lives a lot easier. The bulk of the changes could be accomplished
            with a few simple media queries that switched the CSS from
        ...
        <div className="project-section">
          ...
          <p>
            ...
            Brown community to read. It was an amazing feeling to open up the
            BDH website and see the site I had helped create on the front page!
          </p>
          <ol>
            <li>
              ...
              amount you've scrolled. Yet even relatively simple dynamic
              elements like background and image transitions make the article so
              much more emotionally resonant than if it had been entirely
              static.
            </li>
            <li>
              <b>Don't underestimate simple Javascript libraries.</b> My
              instinct is often to immediately go to the most powerful framework
              to accomplish a task (i.e. React). However, due to the BDH's
              infrastructure, we could only use vanilla Javascript and small
              libraries that could be easily imported. But I never felt
              particularly limited by this constraint—if anything, I felt like
              it pushed me to be more creative in my implementation choices.{" "}
            </li>
          </ol>
          <SeeMoreButton />
        </div>
