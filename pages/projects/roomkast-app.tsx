    ...
    <div>
      ...
      <div className="project-content">
        ...
        <div className="project-section">
          ...
          <p>
            Roomkast describes itself as a "profile-matching tool for people who
            see the value in co-sharing a place to live.”
          </p>
          <p>
            We thought the people most likely to be looking for a roommate would
            be younger people individuals who had just moved to a metropolitan
            area and would like to split rent for an apartment.
          </p>
          <p>
            Given the widespread use of dating apps among young people, we
            thought Roomkast users would prefer to use an interface with similar
            navigation and design elements.
          </p>
        </div>
        <div className="project-section">
          ...
          <p>
            ...
            imagined the app to look like in order to generate a diversity of
            approaches to solving Roomkast’s goals.
          </p>
          <ImageSection
        ...
        <div className="project-section">
          ...
          <p>
            To improve our prototype, we participated in a design critique with
            a UX researcher. Below, you can see how we incorporated feedback
        ...
        <div className="project-section">
          ...
          <div>
            ...
            <p>
              At the same time, the user testing helped validate our intuitions
              about the simplicitly and learnability our designs and user
              experience:{" "}
            </p>
            <ul>
              <li>
              ...
              <li>
                Users understood the compability system intuitively without the
        ...
        <div className="project-section">
          ...
          <ol>
            <li>
              ...
              as the the bottom navbar) allows me to create the best experience
              for my users.
            </li>
            <li>
              ...
              invaluable for detecting issues with our interface that had become
              invisible to us.
            </li>
          </ol>
          <SeeMoreButton />
