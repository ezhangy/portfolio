    ...
    <div>
      ...
      <div className="project-content">
        ...
        <div className="project-section">
          ...
          <p>
            If you look up pictures of the restaurant and bar online, you'll see
            a ton of care was put into the Troop's interior design, with
          ...
          <p>
            ...
            <b>more usable and responsive across device sizes</b>, bringing the
            website in line with the amount of care that was put into the
        ...
        <div className="project-section">
          ...
          <p>
            ...
            site's usability. When identifying problems, I specifically thought
            about usability along the axes of <b>learnability, memorability,</b>{" "}
            and <b>efficiency.</b>
          </p>
        ...
        <div className="project-section">
          ...
          <p>
            ...
            for <b>desktop, tablet,</b> and <b>mobile</b> versions of the site.
          </p>
          <ImageSection
        ...
        <div className="project-section">
          ...
          <p>
            Once I had created the visual style guide. I combined the guide with
            my wireframes to create <b>high-fidelity mockups</b> in Figma. I
            created mockups for each screen size so I would know what CSS media
            queries I would have to use to ensure the site felt great on every
            device.
          </p>
          <ImageSection
          ...
          <div className="inline-section img-and-text">
            <div className="text-wrapper-left">
              ...
              <p>
                ...
                rather than leaving them side by side. Similarly, I laid out the
                event calendar and accent image vertically rather than
                horizontally.
              </p>
            </div>
          ...
          <div className="inline-section img-and-text">
            <div className="text-wrapper-left">
              ...
              <p>
                ...
                moved the info that used to be available below the order/reserve
                buttons into an "Hours & Info" overlay found on the navbar.
              </p>
        ...
        <div className="project-section">
          ...
          <p>
            ...
            happy with how the final result turned out! A responsive website was
            this project's primary goal, and I feel that I achieved that.
          </p>
        ...
        <div className="project-section">
          ...
          <p>
            Redesigning Troop's website taught me important lessons about design
            and web development.
          </p>
          <ol>
            <li>
              <b>Taking away info is as important as adding it.</b> Many of the
              improvements to the interface were based around removing, rather
              than adding additional information (for example, by distilling
              down the navbar options). I think the end result is a sleeker
              interface that is much less confusing to use.
            </li>
            <li>
              <b>There are many time sucks in interface design.</b> I spent too
              long on UI decisions that were ultimately inconsequential, such as
              font type or the specific shade of blue I should use for the
              background. In the end, many of these decisions only marginally
              impacted the aethestic impact of the site, and had no bearing
              whatsover on its usability. These choices can easily derail your
              project, so I learned I had to ruthlessly prioritize.
            </li>
          </ol>
          <SeeMoreButton />
        </div>
